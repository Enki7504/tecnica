...
class cpersonas_list extends cpersonas {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->id_personas->setFormValue($arrKeyFlds[0]);
			if (!is_numeric($this->id_personas->FormValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->padremadretutor->AdvancedSearch->ToJSON(), ","); // Field padremadretutor
		$sFilterList = ew_Concat($sFilterList, $this->division->AdvancedSearch->ToJSON(), ","); // Field division
		$sFilterList = ew_Concat($sFilterList, $this->retirado->AdvancedSearch->ToJSON(), ","); // Field retirado
		$sFilterList = ew_Concat($sFilterList, $this->id_personas->AdvancedSearch->ToJSON(), ","); // Field id_personas
		if ($this->BasicSearch->Keyword <> "") {
	...
	function RestoreFilterList() {
		...
		// Field padremadretutor
		$this->padremadretutor->AdvancedSearch->SearchValue = @$filter["x_padremadretutor"];
		$this->padremadretutor->AdvancedSearch->SearchOperator = @$filter["z_padremadretutor"];
		$this->padremadretutor->AdvancedSearch->SearchCondition = @$filter["v_padremadretutor"];
		$this->padremadretutor->AdvancedSearch->SearchValue2 = @$filter["y_padremadretutor"];
		$this->padremadretutor->AdvancedSearch->SearchOperator2 = @$filter["w_padremadretutor"];
		$this->padremadretutor->AdvancedSearch->Save();
		...
		// Field retirado
		$this->retirado->AdvancedSearch->SearchValue = @$filter["x_retirado"];
		$this->retirado->AdvancedSearch->SearchOperator = @$filter["z_retirado"];
		$this->retirado->AdvancedSearch->SearchCondition = @$filter["v_retirado"];
		$this->retirado->AdvancedSearch->SearchValue2 = @$filter["y_retirado"];
		$this->retirado->AdvancedSearch->SearchOperator2 = @$filter["w_retirado"];
		$this->retirado->AdvancedSearch->Save();

		// Field id_personas
		$this->id_personas->AdvancedSearch->SearchValue = @$filter["x_id_personas"];
		$this->id_personas->AdvancedSearch->SearchOperator = @$filter["z_id_personas"];
		$this->id_personas->AdvancedSearch->SearchCondition = @$filter["v_id_personas"];
		$this->id_personas->AdvancedSearch->SearchValue2 = @$filter["y_id_personas"];
		$this->id_personas->AdvancedSearch->SearchOperator2 = @$filter["w_id_personas"];
		$this->id_personas->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->padremadretutor, $arKeywords, $type);
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->retirado); // retirado
			$this->UpdateSort($this->id_personas); // id_personas
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->retirado->setSort("");
				$this->id_personas->setSort("");
			}
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->id_personas->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event);'>";
...
fpersonaslist.Lists["x_retirado"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpersonaslist.Lists["x_retirado"].Options = <?php echo json_encode($personas->retirado->Options()) ?>;
...
<?php if ($personas->nombre->Visible) { // nombre ?>
	<?php if ($personas->SortUrl($personas->nombre) == "") { ?>
		<th data-name="nombre"><div id="elh_personas_nombre" class="personas_nombre"><div class="ewTableHeaderCaption"><?php echo $personas->nombre->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nombre"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $personas->SortUrl($personas->nombre) ?>',1);"><div id="elh_personas_nombre" class="personas_nombre">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $personas->nombre->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($personas->nombre->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($personas->nombre->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($personas->apellido->Visible) { // apellido ?>
	<?php if ($personas->SortUrl($personas->apellido) == "") { ?>
		<th data-name="apellido"><div id="elh_personas_apellido" class="personas_apellido"><div class="ewTableHeaderCaption"><?php echo $personas->apellido->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="apellido"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $personas->SortUrl($personas->apellido) ?>',1);"><div id="elh_personas_apellido" class="personas_apellido">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $personas->apellido->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($personas->apellido->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($personas->apellido->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($personas->division->Visible) { // division ?>
	<?php if ($personas->SortUrl($personas->division) == "") { ?>
		<th data-name="division"><div id="elh_personas_division" class="personas_division"><div class="ewTableHeaderCaption"><?php echo $personas->division->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="division"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $personas->SortUrl($personas->division) ?>',1);"><div id="elh_personas_division" class="personas_division">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $personas->division->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($personas->division->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($personas->division->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($personas->retirado->Visible) { // retirado ?>
	<?php if ($personas->SortUrl($personas->retirado) == "") { ?>
		<th data-name="retirado"><div id="elh_personas_retirado" class="personas_retirado"><div class="ewTableHeaderCaption"><?php echo $personas->retirado->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="retirado"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $personas->SortUrl($personas->retirado) ?>',1);"><div id="elh_personas_retirado" class="personas_retirado">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $personas->retirado->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($personas->retirado->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($personas->retirado->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($personas->id_personas->Visible) { // id_personas ?>
	<?php if ($personas->SortUrl($personas->id_personas) == "") { ?>
		<th data-name="id_personas"><div id="elh_personas_id_personas" class="personas_id_personas"><div class="ewTableHeaderCaption"><?php echo $personas->id_personas->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_personas"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $personas->SortUrl($personas->id_personas) ?>',1);"><div id="elh_personas_id_personas" class="personas_id_personas">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $personas->id_personas->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($personas->id_personas->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($personas->id_personas->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($personas->nombre->Visible) { // nombre ?>
		<td data-name="nombre"<?php echo $personas->nombre->CellAttributes() ?>>
<span id="el<?php echo $personas_list->RowCnt ?>_personas_nombre" class="personas_nombre">
<span<?php echo $personas->nombre->ViewAttributes() ?>>
<?php echo $personas->nombre->ListViewValue() ?></span>
</span>
<a id="<?php echo $personas_list->PageObjName . "_row_" . $personas_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($personas->apellido->Visible) { // apellido ?>
		<td data-name="apellido"<?php echo $personas->apellido->CellAttributes() ?>>
<span id="el<?php echo $personas_list->RowCnt ?>_personas_apellido" class="personas_apellido">
<span<?php echo $personas->apellido->ViewAttributes() ?>>
<?php echo $personas->apellido->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($personas->dni->Visible) { // dni ?>
...
<?php echo $personas->dni->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($personas->division->Visible) { // division ?>
		<td data-name="division"<?php echo $personas->division->CellAttributes() ?>>
<span id="el<?php echo $personas_list->RowCnt ?>_personas_division" class="personas_division">
<span<?php echo $personas->division->ViewAttributes() ?>>
<?php echo $personas->division->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($personas->retirado->Visible) { // retirado ?>
		<td data-name="retirado"<?php echo $personas->retirado->CellAttributes() ?>>
<span id="el<?php echo $personas_list->RowCnt ?>_personas_retirado" class="personas_retirado">
<span<?php echo $personas->retirado->ViewAttributes() ?>>
<?php echo $personas->retirado->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($personas->id_personas->Visible) { // id_personas ?>
		<td data-name="id_personas"<?php echo $personas->id_personas->CellAttributes() ?>>
<span id="el<?php echo $personas_list->RowCnt ?>_personas_id_personas" class="personas_id_personas">
<span<?php echo $personas->id_personas->ViewAttributes() ?>>
<?php echo $personas->id_personas->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
