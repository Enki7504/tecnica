...
class cpersonas_view extends cpersonas {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["id_personas"] <> "") {
			$this->RecKey["id_personas"] = $_GET["id_personas"];
			$KeyUrl .= "&amp;id_personas=" . urlencode($this->RecKey["id_personas"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["id_personas"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["id_personas"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id_personas"] <> "") {
				...
				$this->RecKey["id_personas"] = $this->id_personas->QueryStringValue;
			} elseif (@$_POST["id_personas"] <> "") {
				$this->id_personas->setFormValue($_POST["id_personas"]);
				$this->RecKey["id_personas"] = $this->id_personas->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("personaslist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (strval($this->id_personas->CurrentValue) == strval($this->Recordset->fields('id_personas'))) {
...
fpersonasview.Lists["x_padremadretutor"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpersonasview.Lists["x_padremadretutor"].Options = <?php echo json_encode($personas->padremadretutor->Options()) ?>;
fpersonasview.Lists["x_retirado"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpersonasview.Lists["x_retirado"].Options = <?php echo json_encode($personas->retirado->Options()) ?>;
...
<?php if (!isset($personas_view->Pager)) $personas_view->Pager = new cPrevNextPager($personas_view->StartRec, $personas_view->DisplayRecs, $personas_view->TotalRecs) ?>
<?php if ($personas_view->Pager->RecordCount > 0 && $personas_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($personas_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $personas_view->PageUrl() ?>start=<?php echo $personas_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($personas_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $personas_view->PageUrl() ?>start=<?php echo $personas_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $personas_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($personas_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $personas_view->PageUrl() ?>start=<?php echo $personas_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($personas_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $personas_view->PageUrl() ?>start=<?php echo $personas_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $personas_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
...
<?php if ($personas->nombre->Visible) { // nombre ?>
	<tr id="r_nombre">
		<td><span id="elh_personas_nombre"><?php echo $personas->nombre->FldCaption() ?></span></td>
...
<?php echo $personas->nombre->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($personas->apellido->Visible) { // apellido ?>
	<tr id="r_apellido">
		<td><span id="elh_personas_apellido"><?php echo $personas->apellido->FldCaption() ?></span></td>
...
<?php echo $personas->apellido->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($personas->padremadretutor->Visible) { // padremadretutor ?>
	<tr id="r_padremadretutor">
		<td><span id="elh_personas_padremadretutor"><?php echo $personas->padremadretutor->FldCaption() ?></span></td>
		<td data-name="padremadretutor"<?php echo $personas->padremadretutor->CellAttributes() ?>>
<span id="el_personas_padremadretutor">
<span<?php echo $personas->padremadretutor->ViewAttributes() ?>>
<?php echo $personas->padremadretutor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($personas->division->Visible) { // division ?>
	<tr id="r_division">
		<td><span id="elh_personas_division"><?php echo $personas->division->FldCaption() ?></span></td>
...
<?php echo $personas->division->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($personas->retirado->Visible) { // retirado ?>
	<tr id="r_retirado">
		<td><span id="elh_personas_retirado"><?php echo $personas->retirado->FldCaption() ?></span></td>
...
<?php echo $personas->retirado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($personas->id_personas->Visible) { // id_personas ?>
	<tr id="r_id_personas">
		<td><span id="elh_personas_id_personas"><?php echo $personas->id_personas->FldCaption() ?></span></td>
...
<?php echo $personas->id_personas->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
